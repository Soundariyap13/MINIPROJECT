...
public class WordPuzzleDoa {
		String dbUrl="jdbc:mysql://localhost:3306/ngpdb";
		String dbUname="root";
		String dbPassword="";
		String dbDriver="com.mysql.cj.jdbc.Driver";
        String name,pass,email,phone;
        WordPuzzleDoa(String name,String pass,String email,String phone){
        	this.name=name;
        	this.pass=pass;
        	this.email=email;
        	this.phone=phone;
         ...
         boolean store(){
    		...
    		try {
    			...
    			String sql1 ="insert into student_table (Email,Password,Name,Phone_no)"
